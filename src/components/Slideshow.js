...
const Slideshow = () => {
    return (
        <Carousel id="main-slide" controls={false}>
            <Carousel.Item>
                ...
                <div className="slider-content">
                    <div className="container">
                        ...
                        <p className="animated2">Curabitur aliquet quam id dui posuere blandit. Praesent sapien massa<br/>  convallis a pellentesque nec, egestas non nisi.</p>
